...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px; margin: 0px;">
            <div class="dialogboxContainerMainMAster">
                <div class="DialogBoxCustom" style="float: left; background-color: #fff; padding-left: 0px; padding-bottom: 2px">
                    <input type="button" name="print" id="BtnPrintJobDetails" class="btn btn-primary" value="Job Details" />
                    <input type="button" name="print" id="BtnPrintCosting" class="btn btn-info" value="Detail Costing Sheet" />
    ...
    <div class="row clearfix p-t-10 margin-0">
        ...
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
            <input type="text" name="statusremark" id="TxtRemarks" class="forTextBox" value="" />
        </div>
