<%@ WebHandler Language="VB" Class="FileUploadSalesOrder" %>
...
Public Class FileUploadSalesOrder : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If context.Request.Files.Count > 0 Then
            ...
            For i As Integer = 0 To files.Count - 1
                ...
                Dim filePath As String = Path.Combine(context.Server.MapPath("Files/SalesOrder/"), fileName)
