    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If context.Request.Files.Count > 0 Then
            ...
            For i As Integer = 0 To files.Count - 1
                ...
                ' Compress the file using Ionic.Zip
                Dim compressedFileName As String = fileName & ".zip"
                Dim compressedFilePath As String = Path.Combine(context.Server.MapPath("Files/Enquiry/"), compressedFileName)
