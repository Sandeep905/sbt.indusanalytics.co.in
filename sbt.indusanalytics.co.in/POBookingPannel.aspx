<%@ Page Title="PO Booking Pannel" Language="VB" MasterPageFile="~/MasterPage_Main.master" AutoEventWireup="false" CodeFile="POBookingPannel.aspx.vb" Inherits="POBookingPannel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="dialogboxContainerMainMAster">
                <div class="DialogBoxCustom" style="float: left; background-color: #fff; padding-left: 0px; padding-bottom: 2px">
                    <div id="ButtonDiv" style="height: auto;">
                        ...
                        <div id="DivApprovaldropdown" style="display: none; flex-direction: row; padding: 3px" class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div id="Approvaldropdown"></div>
                            <input class="forTextBox" style="margin-left: 3px; margin-right: 3px" id="Remarkstatus" placeholder="Reason for updation" />
                            <a class="btn btn-success" id="UpdateAproval">Update</a>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
                             <input type="button" class="btn btn-danger hidden" value="Delete" id="AllDivDeletePrint" />
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
                            <input type="button" class="btn btn-info" style="display: none;" value="Send For  Approval" id="BtnSendForInternalApproval" />
                            <input type="button" class="btn btn-danger" style="display: none;" value="Unsend For  Approval" id="BtnDisInternalApproval" />
                    ...
                    <strong id="MasterDisplayName" class="MasterDisplayName" style="float: right; color: #42909A">Service PO Panel</strong>
    ...
    <script type="text/javascript" src="CustomJS/POBookingPanel.js"></script>
</asp:Content>
