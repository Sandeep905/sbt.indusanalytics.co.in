...
<%--            <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
            ...
            <div class="modal-footer col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <input type="button" class="btn btn-primary" value="Show List" id="BtnShowList" />
        ...
        <div id="myModal_1" class="rowcontents clearfix tab-pane animated fadeInRight hidden">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="modal-footer" style="border-top: 1px solid #42909A;">
                    <button type="button" id="BtnLoadFromList" class="btn btn-link waves-effect">Load</button>
                </div>
            </div>
        </div>
    </div>
