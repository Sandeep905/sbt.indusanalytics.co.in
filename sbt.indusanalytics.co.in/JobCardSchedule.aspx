...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-1 margin-0">
        <input type="button" value="Create" class="btn btn-success" id="BtnCreate" data-toggle="modal" />
    ...
    <div class="modal clearfix" id="ModalCreate" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="DialogBoxCustom" style="float: left; border-top-left-radius: 4px; border-top-right-radius: 4px;">
                        ...
                        <div role="tabpanel" class="row " style="display: block;">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-0 margin-0" style="border-top: 0px solid #42909A; padding-top: 5px">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                                    ...
                                    <input type="text" class="forTextBox disabledbutton" id="TxtPONo" />
                                </div>
                                ...
                                <div role="tabpanel" class="row clearfix tab-pane animated fadeInRight active" style="border-top: 1px solid black">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                                            ...
                                            <input type="text" class="forTextBox" id="TxtRate" />
                ...
                <div class="modal-footer" style="border-top: 1px solid #42909A;">
                    <input type="button" id="BtnSavejc" value="Save JobCard" class="btn btn-success waves-effect" />
                </div>
            </div>
        </div>
                        ...
                        <div role="tabpanel" class="row clearfix tab-pane animated fadeInRight active" style="border-top: 1px solid black">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                                    <%--Quotation Details--%>
                                    <div class="font-11">Salse Order No</div>
                                    <input type="text" class="forTextBox " id="POOrderBookingNo" />
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                                    <div class="font-11">Sales Order Date</div>
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                                    <div class="font-11">QuotaionNo</div>
                                    <input type="text" class="forTextBox disabledbutton" id="QuotaionNo" />
                                </div>

                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                                    <div class="font-11">EnquiryNo</div>
                                    ...
                                    <div class="row" style="display: flex">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 p-5" style="padding-top: 5px">
                                            <table>
                                                ...
                                                <tr style="height: 40px;">
                                                    <td class="col-lg-6 col-md-6 col-sm-6 col-xs-6 p-5"><b>Salse Order No :</b></td>
                                                ...
                                                <tr style="height: 40px;">
                                                    <td class="col-lg-6 col-md-6 col-sm-6 col-xs-6 p-5 "><b>QuotaionNo :</b></td>
                                                    <td id="TDQuoteNo"></td>
                                                </tr>

                                                <tr style="height: 40px;">
                                                    <td class="col-lg-6 col-md-6 col-sm-6 col-xs-6 "><b>EnquiryNo :</b></td>
                                                    <td id="TDEnqNo"></td>
                                                </tr>
                                        ...
                                        <div class="col-12 col-md-12 col-lg-6 col-xl-6" style="border-left: 1px solid gray;">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 p-5" style="padding-top: 5px">
                                                <table>
                                                    ...
                                                    <tr style="height: 40px;">
                                                        <td class="col-lg-6 col-md-6 col-sm-6 col-xs-6 "><b>TotalAmount :</b></td>
