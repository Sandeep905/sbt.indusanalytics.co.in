...
Public Class WebServicePlanWindow
    ...
    Public Function Sendmail() As String
        ...
        Return db.SendEmails(Subject, Body, ToMail)
    End Function
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(ResponseFormat:=ResponseFormat.Json)>
