...
Public Class WebServiceProductionWorkOrderNew
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(ResponseFormat:=ResponseFormat.Json)>
    Public Function SavejobcardSchedule(ByVal JobCardMain As Object, ByVal JobcardContents As Object, ByVal JObCardSchedule As Object, ByVal ProcessArr As Object, ByVal FlagEdit As Boolean, ByVal JobcardId As Int16, ByVal AllocatedMaterial As Object, ByVal jsonObjectsRecordMain As Object, ByVal jsonObjectsRecordDetail As Object, ByVal jsonObjectsRecordMainR As Object, ByVal jsonObjectsRecordDetailR As Object) As String
        Try
            CompanyId = Convert.ToString(HttpContext.Current.Session("CompanyID"))
            UserId = Convert.ToString(HttpContext.Current.Session("UserID"))
            FYear = Convert.ToString(HttpContext.Current.Session("FYear"))
