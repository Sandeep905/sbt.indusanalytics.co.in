...
function LedgerMasterDropDownLoadData() {
    $.ajax({
        async: true,
        type: "POST",
        url: "WebService_LedgerMaster.asmx/ItemMasterLoadList",
        data: '{}',
...
function LedgerWiseGridDataLoad() {
    ...
    $.ajax({
        async: true,
        type: "POST",
        url: "WebService_LedgerMaster.asmx/ItemGroupIDWiseData",
...
function FieldTypeLoadGetData() {
    $.ajax({
        async: true,
        type: "POST",
        url: "WebService_LedgerMaster.asmx/ITEMFieldTypeLoadData",
        data: '{}',
        contentType: 'application/json; charset=utf-8',
        dataType: 'json',
        success: function (results) {
...
$('#BtnUpdate').click(function () {
    ...
    var data = $('#LedgerWiseDataGrid').dxDataGrid('instance')._options.dataSource

    var tdata = [], tobj = {};
    for (var i = 0; i < data.length; i++) {
        tobj = {};
        tobj.ItemGroupFieldID = data[i].ItemGroupFieldID;
    ...
    $.ajax({
        type: "POST",
        url: "WebService_LedgerMaster.asmx/SaveItemConfiguration",
