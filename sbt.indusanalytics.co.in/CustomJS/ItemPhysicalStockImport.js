...
$("#BtnSave").click(function () {
    ...
    try {
        ...
        for (var e = 0; e < dataGrid._options.dataSource.length; e++) {
            if (isNaN(Number(dataGrid._options.dataSource[e].ItemID)) || Number(dataGrid._options.dataSource[e].ItemID) === undefined) continue;
        ...
        swal({
            ...
            function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "WebServiceItemPhysicalVerification.asmx/ImportStockVerificationData",
