                ...
                if (existID.length === 0) {
                    ...
                    for (f = 0; f < newArray.length; f++) {
                        if (newArray[f].OrderUnit.toString().toUpperCase() === newArray[f].PurchaseUnit.toString().toUpperCase() && newArray[f].OrderUnit.toString().toUpperCase() === newArray[f].StockUnit.toString().toUpperCase()) {
                            ...
                            FinalQtyInPurchaseUnit = FinalQtyInPurchaseUnit + Number(StockUnitConversion(newArray[f].ConversionFormula == null ? '' : newArray[f].ConversionFormula.toString(), Number(newArray[f].PurchaseQuantity), Number(newArray[f].UnitPerPacking), Number(newArray[f].WtPerPacking), Number(newArray[f].ConversionFactor), Number(newArray[f].SizeW), Number(newArray[f].UnitDecimalPlace)));
                            FinalQtyInStockUnit = FinalQtyInStockUnit + Number(newArray[f].PurchaseQuantity);
                            RequiredQuantityInPurchaseUnit = RequiredQuantityInPurchaseUnit + Number(StockUnitConversion(newArray[f].ConversionFormula == null ? '' : newArray[f].ConversionFormula.toString(), Number(newArray[f].RequiredQuantity), Number(newArray[f].UnitPerPacking), Number(newArray[f].WtPerPacking), Number(newArray[f].ConversionFactor), Number(newArray[f].SizeW), Number(newArray[f].UnitDecimalPlace)));
                            RequiredQuantityInStockUnit = RequiredQuantityInStockUnit + Number(newArray[f].RequiredQuantity);
                        } else if (newArray[f].OrderUnit.toString().toUpperCase() === newArray[f].PurchaseUnit.toString().toUpperCase() && newArray[f].OrderUnit.toString().toUpperCase() !== newArray[f].StockUnit.toString().toUpperCase()) {
                            FinalQtyInPurchaseUnit = FinalQtyInPurchaseUnit + Number(newArray[f].PurchaseQuantity);
                            FinalQtyInStockUnit = FinalQtyInStockUnit + Number(StockUnitConversion(newArray[f].ConversionFormulaStockUnit == null ? '' : newArray[f].ConversionFormulaStockUnit.toString(), Number(newArray[f].PurchaseQuantity), Number(newArray[f].UnitPerPacking), Number(newArray[f].WtPerPacking), Number(newArray[f].ConversionFactor), Number(newArray[f].SizeW), Number(newArray[f].UnitDecimalPlaceStockUnit)));
                            RequiredQuantityInPurchaseUnit = RequiredQuantityInPurchaseUnit + Number(newArray[f].RequiredQuantity);
                            RequiredQuantityInStockUnit = RequiredQuantityInStockUnit + Number(StockUnitConversion(newArray[f].ConversionFormulaStockUnit == null ? '' : newArray[f].ConversionFormulaStockUnit.toString(), Number(newArray[f].RequiredQuantity), Number(newArray[f].UnitPerPacking), Number(newArray[f].WtPerPacking), Number(newArray[f].ConversionFactor), Number(newArray[f].SizeW), Number(newArray[f].UnitDecimalPlaceStockUnit)));
                        }
